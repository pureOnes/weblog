package com.theone.weblog.pageviews;
...
import com.theone.weblog.weborigin.WebLogBean;
...
false58.215.204.118-2013-09-18 06:51:35
false58.215.204.118-2013-09-18 06:51:36
            ...
            try {
                ...
                for (int i = 0; i < beans.size(); i++) {
					...
					beans集合
						...
						false58.215.204.118-2013-09-18 07:51:37
    ...
    public static void main(String[] args) throws Exception {
        ...
        Path outPath = new Path("F:\\pinyougou_tools\\pageviews");
...
//		FileOutputFormat.setOutputPath(job, new Path(args[1]));
        ...
        FileInputFormat.setInputPaths(job, new Path("F:\\pinyougou_tools\\output"));
        FileOutputFormat.setOutputPath(job, new Path("F:\\pinyougou_tools\\pageviews"));
