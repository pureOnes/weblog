package com.theone.weblog.visits;
...
import com.theone.weblog.pageviews.PageViewsBean;
...
//334d7b28-4427-4571-981c-eed054272b95220.181.89.174-2013-09-18 15:32:52/about1122"-""Sogouwebspider/4.0(+http://www.sogou.com/docs/help/webmasters.htm#07)"5301
    ...
    public static void main(String[] args) throws Exception {
        ...
        Path outPath = new Path("F:\\pinyougou_tools\\visitout");
...
//		FileOutputFormat.setOutputPath(job, new Path(args[1]));
        FileInputFormat.setInputPaths(job, new Path("F:\\pinyougou_tools\\pageviews"));
